...
from .sac_bc import SACBCPolicy
from .rql import RQLPolicy
...
from .cql_adaloss import CQLAdaLossPolicy
...
class EDACCommandModePolicy(EDACPolicy, DummyCommandModePolicy):
    pass

@POLICY_REGISTRY.register('sac_bc_command')
class SACCommandModePolicy(SACBCPolicy, DummyCommandModePolicy):
    pass

@POLICY_REGISTRY.register('rql_command')
class RQLCommandModePolicy(RQLPolicy, DummyCommandModePolicy):
    pass
...
@POLICY_REGISTRY.register('cql_adaloss_command')
class CQLAdaLossCommandModePolicy(CQLAdaLossPolicy, EpsCommandModePolicy):
    pass
