...
class DDPGPolicy(Policy):
    ...
    def _state_dict_learn(self) -> Dict[str, Any]:
        ...
        if self._cfg.learn.lr_scheduler.get('flag', None):
            ret['lr_scheduler_critic'] = self._lr_scheduler_critic.state_dict()
            ret['lr_scheduler_actor'] = self._lr_scheduler_actor.state_dict()
        return ret
    ...
    def _load_state_dict_learn(self, state_dict: Dict[str, Any]) -> None:
        ...
        if self._cfg.learn.lr_scheduler.get('flag', None):
            self._lr_scheduler_critic.load_state_dict(state_dict['lr_scheduler_critic'])
            self._lr_scheduler_actor.load_state_dict(state_dict['lr_scheduler_actor'])
